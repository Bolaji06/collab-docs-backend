 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.documentDelta`: Exposes CRUD operations for the **DocumentDelta** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more DocumentDeltas
      * const documentDeltas = await prisma.documentDelta.findMany()
      * ```
      */
    get documentDelta(): Prisma.DocumentDeltaDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
